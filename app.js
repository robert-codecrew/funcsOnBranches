...
let mySum = a+b;
let mySumString = `The sum of ${a} and ${b} is ${mySum}`
...
let myMultipliedArray = [product, productString];

return myMultipliedArray
}
...
and the third and fourth elements are strings
